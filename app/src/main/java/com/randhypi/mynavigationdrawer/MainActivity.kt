package com.randhypi.mynavigationdrawer
...
import com.randhypi.mynavigationdrawer.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        profileCircleImageView = binding.navView.getHeaderView(0).findViewById(R.id.imageView)
        Glide.with(this)
